...
class AddTranslatedFieldListener implements EventSubscriberInterface
{
    /**
        ...
        foreach ($this->getFieldNames() as $locale => $fields) {
            foreach ($fields as $field_key => $field_name) {
                ...
                $collection[] = array(
                    ...
                    'fieldLabel' => isset($this->options['labels'][$field_key]) ? $this->options['labels'][$field_key] : $field_key
                );
            }
        }
...
//        if (isset($this->options['attr']['subclass']) and $this->options['attr']['subclass']){
//            $class = $this->options['attr']['subclass'];
//        }
